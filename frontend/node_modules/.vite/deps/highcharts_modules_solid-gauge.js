  ...
  "../node_modules/highcharts/modules/solid-gauge.js"(exports, module) {
    ...
    */
    function(t, e) {
      ...
      a.d(n, { default: () => N });
      var l = a(944), d = a.n(l);
      let { defaultOptions: h } = d(), { noop: c } = d(), { addEvent: g, extend: p, isObject: u, merge: f, relativeLength: m } = d(), y = { radius: 0, scope: "stack", where: void 0 };
      function x(t2, e2) {
        return u(t2) || (t2 = { radius: t2 || 0 }), f(y, e2, t2);
      }
      let C = { optionsToObject: x };
      var R = a(512), v = a.n(R), A = a(620);
      let { parse: b } = a.n(A)(), { merge: w } = d();
      !function(t2) {
        t2.initDataClasses = function(t3) {
          ...
          for (let t4 = 0, o3 = r2.length; t4 < o3; ++t4)
            i2 = w(i2 = r2[t4]), a2.push(i2), (e2.styledMode || !i2.color) && ("category" === s2.dataClassColor ? (e2.styledMode || (n2 = (d2 = e2.options.colors || []).length, i2.color = d2[l2]), i2.colorIndex = l2, ++l2 === n2 && (l2 = 0)) : i2.color = b(s2.minColor).tweenTo(b(s2.maxColor), o3 < 2 ? 0.5 : t4 / (o3 - 1)));
        }, t2.initStops = function() {
          let t3 = this.options, e2 = this.stops = t3.stops || [[0, t3.minColor || ""], [1, t3.maxColor || ""]];
          for (let t4 = 0, o2 = e2.length; t4 < o2; ++t4)
            e2[t4].color = b(e2[t4][1]);
          ...
          if (l2) {
            for (n2 = l2.length; n2--; )
              if (s2 = (a2 = l2[n2]).from, r2 = a2.to, (void 0 === s2 || t3 >= s2) && (void 0 === r2 || t3 <= r2)) {
      ...
      let M = s, { extend: H } = d(), I = { init: function(t2) {
        H(t2, M);
      } }, { gauge: _, pie: j } = v().seriesTypes, { clamp: P, extend: S, isNumber: k, merge: O, pick: T, pInt: z } = d();
      class D extends _ {
        translate() {
          let t2 = this.yAxis;
        ...
        drawPoints() {
          ...
          for (let i3 of (k(s2.threshold) && (t2 = e2.startAngleRad + e2.translate(s2.threshold, void 0, void 0, void 0, true)), this.thresholdAngleRad = T(t2, e2.startAngleRad), this.points))
            if (!i3.isNull) {
              ...
              let v2 = a2 ? "50%" : 0;
              s2.borderRadius && (v2 = C.optionsToObject(s2.borderRadius).radius), i3.shapeArgs = p2 = { x: o2[0], y: o2[1], r: t3, innerR: l2, start: x2, end: R2, borderRadius: v2 }, i3.startR = t3, c2 ? (u2 = p2.d, c2.animate(S({ fill: f2 }, p2)), u2 && (p2.d = u2)) : i3.graphic = c2 = r2.arc(p2).attr({ fill: f2, "sweep-flag": 0 }).add(this.group), this.chart.styledMode ? ((_a = this.yAxis) == null ? void 0 : _a.stops) && (m2 = m2.replace(/highcharts-color-\d/gm, "").trim()) : ("square" !== s2.linecap && c2.attr({ "stroke-linecap": "round", "stroke-linejoin": "round" }), c2.attr({ stroke: s2.borderColor || "none", "stroke-width": s2.borderWidth || 0 })), c2 && c2.addClass(m2);
            }
        }
        animate(t2) {
      ...
      D.defaultOptions = O(_.defaultOptions, { colorByPoint: true, dataLabels: { y: 0 } }), v().registerSeriesType("solidgauge", D);
      let N = d();
      return n.default;
    })());
  }
